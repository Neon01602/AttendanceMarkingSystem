    ...
    for (x, y, w, h) in faces:
        ...
        if prediction[1]<500:
                ...
                if names[prediction[0]] not in marked:
                        cursor.execute("INSERT INTO attendance (student_id, attendance_date, attendance_status, student_name) VALUES (%s, %s, %s, %s)", (prediction[0], '2024-07-27', 'Present', names[prediction[0]]))
